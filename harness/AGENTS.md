...
| Hang, stuck UT, GPU 100% | `skills/hang_detect_fix.md` + `commands/hang_detect_fix.md` | Preserve the broad UT, reproduce the affected kernel path under focused pressure, then capture cuda-gdb diagnostics from the reproduced hang. |
